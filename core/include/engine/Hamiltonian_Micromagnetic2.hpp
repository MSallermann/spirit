...
*/
        ...
        std::vector<std::vector<scalar>> anisotropy_magnitudes;//=scalarfield(16,0);
        std::vector<std::vector<Vector3>> anisotropy_normals;//=vectorfield(16, Vector3{0, 0, 1});
        scalarfield  exchange_stiffness;
        scalarfield  dmi;
		...
		public:
			...
			void run(const vectorfield& spins, vectorfield& gradient) {
				...
				vectorfield real = vectorfield(16 * 16, { 0,0,0 });
				vectorfield imag = vectorfield(16 * 16, { 0,0,0 });
				//for (int index = 0; index < 3; index++) {
					...
					//std::cout << spins[16 + 32 * 16][index] << " " << real[16 + 32 * 16][index] << " " << imag[16 + 32 * 16][index] << " 0\n";
					for (int i = 0; i < 16 * 16; i++) {
					...
					//std::cout << spins[16 + 32 * 16][index] << " " << real[16 + 32 * 16][index] << " " << imag[16 + 32 * 16][index] << " backward\n";

				//}


/*
				std::cout << spins[16 + 32 * 16][0] << " " << real[16 + 32 * 16][0] << " " << imag[16 + 32 * 16][0] << " 0\n";
				std::cout << spins[16 + 32 * 16][1] << " " << real[16 + 32 * 16][1] << " " << imag[16 + 32 * 16][1] << " 1\n";
				std::cout << spins[16 + 32 * 16][2] << " " << real[16 + 32 * 16][2] << " " << imag[16 + 32 * 16][2] << " 2\n";
*/
				/*
				...
				std::cout << spins[32 + 32 * 16][0] << " " << gradient[32 + 32 * 16][0] << " 0\n";
				std::cout << spins[32 + 32 * 16][1] << " " << gradient[32 + 32 * 16][1] << " 1\n";
				std::cout << spins[32 + 32 * 16][2] << " " << gradient[32 + 32 * 16][2] << " 2\n";*/
