#pragma once
#ifndef SPIRIT_CORE_ENGINE_METHOD_BSGD_HPP
#define SPIRIT_CORE_ENGINE_METHOD_BSGD_HPP
...
/*
    The biased squared gradient descent (BSGD) method
*/
template<Solver solver>
class Method_BSGD : public Method_Solver<solver>
{
public:
    // Constructor
    Method_BSGD( std::shared_ptr<Data::Spin_System> system, int idx_img, int idx_chain );
