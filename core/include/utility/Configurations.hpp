...
namespace Utility
{
    namespace Configurations
    {
        ...
        void APStripe(Data::Spin_System& s, Vector3 direction, filterfunction filter = defaultfilter);
        ...
        void Vortex(Data::Spin_System& s, Vector3 pos, scalar r, scalar speed, scalar order, bool upDown, bool achiral, bool rl, bool experimental, filterfunction filter = defaultfilter);
        // Spin Spiral
