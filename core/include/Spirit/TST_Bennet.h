...
PREFIX float TST_Bennet_Calculate(State * state, int idx_image_minimum, int idx_image_sp, int n_chain=2, int n_iterations_bennet=5000, int idx_chain=-1) SUFFIX;
